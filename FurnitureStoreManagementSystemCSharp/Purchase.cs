...
namespace FurnitureStoreManagementSystemCSharp
{
    public partial class Purchase : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Вадим Макаренко\OneDrive\Desktop\FurnitureStoreManagementSystemCSharp\FurnitureStoreManagementSystemCSharp\furniture.mdf;Integrated Security=True");
            con.Open();
        ...
        {
            // TODO: This line of code loads data into the 'furnitureDataSet1.purchase_f' table. You can move, or remove it, as needed.
